...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'twitter', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'entries', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'hiddenTweets', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function getHiddenTweets()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHiddenTweets', []);

        return parent::getHiddenTweets();
    }
    ...
    public function setHiddenTweets($hiddenTweets)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHiddenTweets', [$hiddenTweets]);

        return parent::setHiddenTweets($hiddenTweets);
    }
