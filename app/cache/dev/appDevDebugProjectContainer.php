...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_bundle.event.pre_persist' => 'getAppBundle_Event_PrePersistService',
    ...
    /**
     * Gets the 'app_bundle.event.pre_persist' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\DefaultListenerEntity A AppBundle\EventListener\DefaultListenerEntity instance.
     */
    protected function getAppBundle_Event_PrePersistService()
    {
        return $this->services['app_bundle.event.pre_persist'] = new \AppBundle\EventListener\DefaultListenerEntity($this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist'), $this->get('app_bundle.event.pre_persist'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'joel_mora', 'user' => 'homestead', 'password' => 'secret', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fbbf5326666372ebc1ff9c771cd5bb6cceea53eb3e876aed3e9c7018f498144a');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entry/.+/show');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entry/new');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entry/.+/edit');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entry/.+/delete');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entry');
        ...
        $r->add($j, array(0 => 'ROLE_USER'), NULL);
        ...
        $r->add($o, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('86b90694d21033f3312c1a908ebf51f4832fdd88');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '86b90694d21033f3312c1a908ebf51f4832fdd88',
            'twitter_key' => 'hM6D4DL0O7Bx5tG4Ql7N78uHQ',
            'twitter_token' => 'QWJXMATtFBuGHZpVYpnXUJVG1ScwEfamY0ouHhYC2f7pHF6TX7',
            'twitter_timeline_limit' => 40,
            'locale' => 'en',
            ...
            'kernel.secret' => '86b90694d21033f3312c1a908ebf51f4832fdd88',
